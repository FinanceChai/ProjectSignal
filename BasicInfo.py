...
<a href="{pair['url']}">DexScreener</a> + <a href="https://rugcheck.xyz/tokens/{contract_address}">Rugcheck</a> + <a href="app.bubblemaps.io/sol/token/{contract_address}">BubbleMaps</a>
